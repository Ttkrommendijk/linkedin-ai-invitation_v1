...
Deno.serve(async (req: Request) => {
  ...
  if (req.method === "GET") return json({ name: "LEF CRM MCP", status: "authentication_required", resource_metadata: `${MCP_URL}/.well-known/oauth-protected-resource` });
  ...
  if (method === "initialize") return rpcResult(id, { protocolVersion: params?.protocolVersion || "2025-06-18", capabilities: { tools: { listChanged: false } }, serverInfo: { name: "lef-crm", version: "1.3.1" } });
